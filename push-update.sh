...
updates_dir=/data/hertzifyos_updates
...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have Hertzify-VERSION-DATE-TYPE-* as format"
...
$ADB shell "killall com.hertzify.updater 2>/dev/null"
$ADB shell "sqlite3 /data/data/com.hertzify.updater/databases/updates.db" \
