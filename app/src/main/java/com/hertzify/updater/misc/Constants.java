 ...
 */
package com.hertzify.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_ALLOW_MAJOR_UPGRADES = "hertify.updater.allow_major_upgrades";
    public static final String PROP_BUILD_DATE = "ro.build.date.utc";
    public static final String PROP_BUILD_VERSION = "ro.hertify.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.hertify.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.hertify.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "hertify.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "hertify.updater.uri";
